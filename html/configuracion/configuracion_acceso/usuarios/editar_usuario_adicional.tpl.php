			...
			<h1>Configuración de Acceso - Editar Usuario</h1>
				...
				<div class="formulario">
						...
						<div class="datatable">
							...
							<form action="<?=URL?>?page=configuracion&action=update_usuario_adicional" method="POST"  class="form_acceso_2"  accept-charset="utf-8">
								...
								<input type="hidden" name="usuario_id" value="<?=$_SESSION["equivida"]["id"]?>" id="usuario_id">
								<input type="hidden" name="usuario_padre" value="<?=$_SESSION["equivida"]["username"]?>" id="usuario_padre">
