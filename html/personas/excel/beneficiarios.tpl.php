...
header("Content-Disposition: filename=Equivida-Beneficiarios".date("Y-m-d").".xls");
...
for($i=0;$i<count($this->lista_beneficios);$i++){
	...
	if($this->lista_beneficios[$i]->nombre!=""){
		
		$this->lista_beneficios[$i]->nombre=str_replace("Ð","Ñ",$this->lista_beneficios[$i]->nombre);
		?>
		<tr>
			<td><?=$this->lista_beneficios[$i]->nombre?></td>
			<td style="text-align:center"><?=$this->lista_beneficios[$i]->fechaAlta?></td>
			<td style="text-align:center"><?=$this->lista_beneficios[$i]->parentesco?></td>
			<td style="text-align:center"><?=$this->lista_beneficios[$i]->pjePartic?>&nbsp;%</td>
			<td style="text-align:center"><?=$this->lista_beneficios[$i]->tipoBeneficiario?></td>
		</tr>
		<?
	}
