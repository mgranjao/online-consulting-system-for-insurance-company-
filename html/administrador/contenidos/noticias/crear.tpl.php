							...
							<div class="area_trabajo">
								...
								<div class="inside">
									...
									<h4>Noticias</h4>
										...
										<a href="<?=URL?>?page=administrador&action=noticias" class="regresar"></a>
											...
											<div class="formulario">
												...
												<form action="<?=URL?>?page=administrador&action=save_noticia" class="form_default" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
