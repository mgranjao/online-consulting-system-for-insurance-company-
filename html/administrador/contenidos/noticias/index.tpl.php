							...
							<div class="area_trabajo">
								...
								<div class="inside">
									...
									<h4>Noticias</h4>
										...
										<a href="<?=URL?>?page=administrador&action=crear_noticia">Crear noticia</a>
														...
														for($i=0;$i<count($this->noticias);$i++){
															...
															<tr>
																...
																<td>
																		...
																		<a href="<?=URL?>?page=administrador&action=editar_noticia&id=<?=$this->noticias[$i]["id"]?>">
																	...
																	<td>
																		<a href="<?=URL?>?page=administrador&action=delete_noticia&id=<?=$this->noticias[$i]["id"]?>"  title="¿Deseas eliminar esta noticia?" class="eliminar">
