									...
									<h4>Noticias</h4>
										...
										<p>
											...
											<div class="formulario">
												...
												<form action="<?=URL?>?page=administrador&action=actualizar_noticia" class="form_default" method="POST" accept-charset="utf-8"  enctype="multipart/form-data">
														...
														if($this->noticia[0]["imagen"]!=""){
															?>
															 <img src="<?=URL?><?=$this->noticia[0]["imagen"]?>" />
															<?
														}else{
															?>
															[No hay imagen]
