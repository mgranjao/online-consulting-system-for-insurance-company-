				...
				<div class="inside">
					...
					<div class="panel_admin">
						...
						<div class="right_admin">
						 ...
						 <ul class="imprimir">
                                    <li><a href="<?=URL?>?page=administrador&action=accionistas_usuario_seguimiento&format=excel" class="exportar">Exportar</a></li>
														...
														for($i=0;$i<count($this->users);$i++){
															?>
																<tr>
																	...
																	<td><?=$this->users[$i]["numero_de_documento"]?></td>
																	...
																	<td>
																		<a href="<?=URL?>?page=administrador&action=delete_usuario_usuario_seguimiento&id=<?=$this->users[$i]["id"]?>&back=accionista" class="eliminar">
