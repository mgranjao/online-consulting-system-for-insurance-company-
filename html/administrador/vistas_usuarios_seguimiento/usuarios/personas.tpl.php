		...
		<div class="formulario_crear">
			...
			<div class="body_box">
				...
				<div class="inside">
			        ...
			        <ul class="imprimir">
                                    <li><a href="<?=URL?>?page=administrador&action=personas_usuario_seguimiento&format=excel" class="exportar">Exportar</a></li>
														...
														for($i=0;$i<count($this->users);$i++){
															?>
																<tr>
																	...
																	<td>
																		<a href="<?=URL?>?page=administrador&action=delete_usuario_usuario_seguimiento&id=<?=$this->users[$i]["id"]?>&back=personas"  title="¿Deseas eliminar este usuario?" class="eliminar">
