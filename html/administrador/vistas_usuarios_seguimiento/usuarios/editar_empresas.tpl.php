								...
								<div class="inside">
										...
										<div class="formulario">
                                                                                     ...
                                                                                     <div class="password">
                                                                                        ...
                                                                                        <p>Enviar correo para recuprar password al cliente:
											</p>
											<p>
                                                                                        <form action="<?=URL?>?page=administrador&action=enviar_password_usuario_usuario_seguimiento" class="form_default" method="POST" accept-charset="utf-8">
										...
										<form action="<?=URL?>?page=administrador&action=update_usuario_usuario_seguimiento" class="form_default" method="POST" accept-charset="utf-8">
										...
										<p>
												...
												if($this->usuarios[0]["forget"]!=""){
														$password=$this->usuarios[0]["forget1"];	
												}else{
												...
												<p >
													...
													<input type="text" name="password" value="<?=$password?>" id="password">
																...
																<?php
																		...
																		for($i=0;$i<count($this->direcciones);$i++){
																			?>
																				...
																				<a href="<?=URL?>?page=configuracion&action=editar_direccion_usuario_seguimiento&id=<?=$this->direcciones[$i]["id"]?>"><img src="<?=URL?>images/icon_edit.png"></a>
																				<a href="<?=URL?>?page=configuracion&action=borrar_direccion_usuario_seguimiento&id=<?=$this->direcciones[$i]["id"]?>" class="eliminar" title="¿Deseas eliminar la dirección?"><img src="<?=URL?>images/delete.png"></a> <br>
																			<?php
																		}
																		?>
																	...
																	<?php
																			...
																			for($i=0;$i<count($this->telefonos);$i++){
																				?>
																					...
																					<a href="<?=URL?>?page=configuracion&action=editar_telefono_usuario_seguimiento&id=<?=$this->telefonos[$i]["id"]?>"><img src="<?=URL?>images/icon_edit.png"></a>
																					<a href="<?=URL?>?page=configuracion&action=borrar_telefono_usuario_seguimiento&id=<?=$this->telefonos[$i]["id"]?>" class="eliminar" title="¿Deseas eliminar la dirección?"><img src="<?=URL?>images/delete.png"></a> <br>
																				<?php
																			}
																			?>
														...
														<div class="panel_usuarios">
																...
																<a href="<?=URL?>?page=administrador&action=usuario_nuevo_usuario_seguimiento&id=<?=$_GET["id"]?>&username=<?=$this->usuarios[0]["email"]?>" class="crear_usuario">Crear Usuario</a>
																...
																<tbody>
																	...
																	for($i=0;$i<count($this->usuarios_adicionales);$i++){
																		...
																		<tr>
																			...
																			<td>Adicional</td>
																			<td> <a href="<?=URL?>?page=administrador&action=editar_usuario_adicional_usuario_seguimiento&id=<?=$this->usuarios_adicionales[$i]["id"]?>"><img src="<?=URL?>images/icon_edit.png" width="17" height="18" alt="Icon Edit"> </a> </td>
																		
																			<td> <a href="<?=URL?>?page=administrador&action=eliminar_usuario_adicional_usuario_seguimiento&id=<?=$this->usuarios_adicionales[$i]["id"]?>" class="eliminar" title="¿Deseas borrar el registro?"><img src="<?=URL?>images/delete.png"></a> </td>
