							...
							<div class="area_trabajo">
								...
								<div class="inside">
										...
										<div class="formulario">
													...
													<form action="<?=URL?>?page=administrador&action=save_usuario_usuario_seguimiento" method="POST"  class="form_acceso_2"  accept-charset="utf-8">
