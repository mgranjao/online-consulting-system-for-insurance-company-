							...
							<div class="area_trabajo">
								...
								<div class="inside">
									...
									<p>
									 ...
									 <ul class="imprimir">
                                    <li><a href="<?=URL?>?page=administrador&action=brokers_usuario_seguimiento&format=excel" class="exportar">Exportar</a></li>
														...
														for($i=0;$i<count($this->users);$i++){
															?>
																<tr>
																	...
																	<td>
																		<a href="<?=URL?>?page=administrador&action=delete_usuario_usuario_seguimiento&id=<?=$this->users[$i]["id"]?>&back=brokers" title="¿Deseas eliminar este usuario?" class="eliminar">
