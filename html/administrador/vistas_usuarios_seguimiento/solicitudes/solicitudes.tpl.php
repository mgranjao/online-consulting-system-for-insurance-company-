								...
								<div class="inside">
										...
										<p>
											...
											switch($this->usuarios[0]["tipo_usuario_id"]){
												...
												<a href="<?=URL?>?page=administrador&action=personas_usuario_seguimiento" class="regresar"></a>
												<?
												break;
												...
												<a href="<?=URL?>?page=administrador&action=empresas_usuario_seguimiento" class="regresar"></a>
												<?
												break;
												...
												<a href="<?=URL?>?page=administrador&action=brokers_usuario_seguimiento" class="regresar"></a>
												<?
												break;
												...
												<a href="<?=URL?>?page=administrador&action=accionistas_usuario_seguimiento" class="regresar"></a>
												<?
												break;
									...
									<p>
										...
										<a href="<?=URL?>?page=administrador&action=editar_usuario_usuario_seguimiento&id=<?=$this->usuarios[0]["id"]?>">Ver perfil del Usuario</a>
									</p>
														...
														for($i=0;$i<count($this->solicitudes);$i++){
															...
															?>
																<tr>
																	...
																	<td> <a href="<?=URL?>?page=administrador&action=ver_solicitud_usuario_seguimiento&id=<?=$this->solicitudes[$i]["id"]?>"><img src="<?=URL?>images/view_solicitudes.png" width="24" height="24" alt="View Solicitudes"> </a> </td>
																</tr>
															<?php
														}
