						...
						<div class="right_admin">
							...
							<div class="area_trabajo">
								...
								<div class="inside">
										...
										<a href="<?=URL?>?page=administrador&action=directorios_usuario_seguimiento" class="regresar"></a>
											...
											<div class="formulario">
												...
												<form action="<?=URL?>?page=administrador&action=update_archivo_usuario_seguimiento" class="login_admin" method="post" enctype="multipart/form-data">
