				...
				<div class="inside">
					...
					<div class="panel_admin">
						...
						<div class="right_admin">
						 ...
						 <ul class="imprimir">
                                    <li><a href="<?=URL?>?page=administrador&action=accionistas&format=excel" class="exportar">Exportar</a></li>
														...
														for($i=0;$i<count($this->users);$i++){
															?>
																<tr>
																	...
																	<td>
																		<a href="<?=URL?>?page=administrador&action=delete_usuario&id=<?=$this->users[$i]["id"]?>&back=accionista" class="eliminar">
