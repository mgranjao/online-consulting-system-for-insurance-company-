							...
							<div class="area_trabajo">
								...
								<div class="inside">
									...
									<p>
									 ...
									 <ul class="imprimir">
                                    <li><a href="<?=URL?>?page=administrador&action=brokers&format=excel" class="exportar">Exportar</a></li>
														...
														for($i=0;$i<count($this->users);$i++){
															?>
																<tr>
																	...
																	<td>
																		<a href="<?=URL?>?page=administrador&action=delete_usuario&id=<?=$this->users[$i]["id"]?>&back=brokers" title="¿Deseas eliminar este usuario?" class="eliminar">
