							...
							<div class="area_trabajo">
								...
								<div class="inside">
										...
										<div class="formulario">
												...
												<form action="<?=URL?>?page=administrador&action=update_usuario_administrador" method="POST"  class="form_acceso_administrador"  accept-charset="utf-8">
													...
													<input type="hidden" name="id" value="<?=$this->usuario_seguimiento[0]["id"]?>" id="usuario_id">
                                                                                                        ...
                                                                                                        <p>
														<label>Usuario <span class="campo_obligatorio">*</span> </label>
														<input type="text" name="usuario" value="<?=$this->usuario_administrador[0]["usuario"]?>" id="usuario"  autocomplete="off">
