										...
										<div class="formulario">
												...
												<form action="<?=URL?>?page=administrador&action=update_usuario_seguimiento" method="POST"  class="form_acceso_2"  accept-charset="utf-8">
													...
													<div id="error_verificar_password"></div>
															...
															<input type="checkbox" name="permiso_polizas_colectivas" value="1" id="permiso_polizas_colectivas" <?if ($this->usuario_seguimiento[0]["permiso_polizas_colectivas"]==1) {?>checked<?}?>>
														</p>
