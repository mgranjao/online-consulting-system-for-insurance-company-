		...
		switch($_POST["rol"]){
			case "persona":
				$message = Swift_Message::newInstance($_POST["asunto"])
				  ...
				  ->setBcc(array(
		  			'bedomax@gmail.com'=>'Bedo Caceres',
		  			'fyanez@equivida.com' => 'Fernando Yanez',
					'servicioalcliente@equivida.com' => 'Soporte Equivida'
						...
						case 'actualizacion':
							...
							$message = Swift_Message::newInstance($_POST["asunto"])
							  ...
							  ->setBcc(array(
					  			'bedomax@gmail.com'=>'Bedo Caceres',
					  			'fyanez@equivida.com' => 'Fernando Yanez',
								'anunez@equivida.com' => 'Soporte Equivida',
                                                                'atencioncolectivos@equivida.com' => 'Soporte Equivida'
								));
			...
			case "accionista":
					$message = Swift_Message::newInstance($_POST["asunto"])
					  ...
					  ->setBcc(array(
			  			'bedomax@gmail.com'=>'Bedo Caceres',
			  			'fyanez@equivida.com' => 'Fernando Yanez',
						'lhinojosa@equivida.com' => 'Soporte Equivida'
						));
			break;
			case "usuario":
				$message = Swift_Message::newInstance($_POST["asunto"])
	...
	case "notificar":
		...
		$message = Swift_Message::newInstance($_POST["asunto"])
		  ...
		  ->setBcc(array(
  			...
  			'fyanez@equivida.com' => 'Fernando Yanez',
			'servicioalcliente@equivida.com' => 'Soporte Equivida',
  			'adiaz@equivida.com' => 'Fernando Yanez',
  			'jsosa@equivida.com' => 'Fernando Yanez',
  			'mcamano@equivida.com' => 'Fernando Yanez',
  			'solalla@equivida.com' => 'Fernando Yanez'
  			));
			...
			case "persona":
					...
					$message = Swift_Message::newInstance($_POST["asunto"])
					  ...
					  ->setBcc(array(
			  			...
			  			'fyanez@equivida.com' => 'Fernando Yanez',
						'servicioalcliente@equivida.com' => 'Soporte Equivida',
						'solalla@equivida.com' => 'Soporte Equivida',
						'hmaldonado@equivida.com' => 'Soporte Equivida',
						'lutreras@equivida.com' => 'Soporte Equivida',
						'pmatute@equivida.com' => 'Soporte Equivida',
						'apolo@equivida.com' => 'Soporte Equivida',
						'pgutierrez@equivida.com' => 'Soporte Equivida'
